  ...
  (function (devtool) {
    ...
    function start() {
      ...
      function r() {
        ...
        var webplayer =t['egret-player'];
        // webplayer.playerOption.fpsStyles = {x: '0', y: '0', size: '12', textColor: '0xffffff', bgAlpha: '0.9'}
        webplayer.showFPS = true;
        webplayer.player.showFPS = true;
        webplayer.player.displayFPS(true, false, webplayer.playerOption.logFilter, webplayer.playerOption.fpsStyles);
        return webplayer.stage;
      }
      function i() {
        return (
          egret.MainContext &&
